                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>{lancFiltrados.map(l => (
                      <tr key={l.id} className="border-b border-slate-800/50 hover:bg-slate-800/30">
                        ...
                        <td className="hidden sm:table-cell px-3 text-slate-300">{l.cliente}</td><td className="text-right px-3">{fmt(l.totalFatura)}</td>
                        <td className="hidden md:table-cell text-right px-3 text-orange-400">{fmt(l.totalPago)}</td><td className="hidden md:table-cell text-right px-3 text-emerald-400 font-medium">{fmt(l.lucro)}</td>
                    ...
                    <tfoot className="bg-slate-900 border-t border-slate-800 font-medium"><tr><td colSpan={2} className="py-2.5 px-3 text-slate-400">Total ({lancFiltrados.length})</td><td className="hidden sm:table-cell"></td><td className="text-right px-3">{fmt(totais.fat)}</td><td className="hidden md:table-cell text-right px-3 text-orange-400">{fmt(totais.pag)}</td><td className="hidden md:table-cell text-right px-3 text-emerald-400">{fmt(totais.luc)}</td><td colSpan={2}></td></tr></tfoot>
                  </table>
                </div>
              </div>
            )}
        ...
        {aba === 'funcionarios' && (
          <div className="space-y-4">
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="text-xs text-slate-400 bg-slate-900 border-b border-slate-800"><tr><th className="text-left py-3 px-3">Nome</th><th className="text-left px-3">Categoria</th><th className="hidden sm:table-cell text-left px-3">CPF</th><th className="hidden sm:table-cell text-left px-3">Pix</th><th className="hidden sm:table-cell text-center px-3">Status</th><th className="text-right px-3">Ações</th></tr></thead>
